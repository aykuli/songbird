    ...
    [
        {
            ...
            name: 'Сорока',
            species: 'Pica pica',
            description: 'Cорока, может стать домашним питомцем. Эти пернатые быстро привыкают к человеку, адаптируются к окружающим условиям. Вскормленные человеком, взрослые сороки узнают хозяина в лицо.',
            imgTag: 'pica',
            ...
            description: 'Грач летает со скоростю до 85 километров в час. Отличить грача от вороны можно по более тонкому и прямому клюву и торчащим в стороны перьям на ногах.',
            imgTag: 'frugilegus',
            ...
            description: 'Вороны – умные птицы. Они умеют блестяще маневрировать в воздухе и ходить по земле.\nВороны ведут сложную социальную жизнь. Легко приспосабливаются к изменениям в условий среды.',
            imgTag: 'corax',
            ...
            description: 'Дрозд — лучший певец из отряда воробьиных. Песня состоит только из красивых звучных свистов и коротких трелей. Ее слышно утром и вечером. Поют в течении всего периода гнездования.',
            imgTag: 'philomelos',
            ...
            description: 'Сойки умеют имитировать голоса других птиц, животных и даже звуки человека. Сойка выкрикивает «кре-кре», «рахх — рах — рахх».',
            imgTag: 'glandarius',
    ...
    ], [
        {
            ...
            description: 'На одного петуха в стае должно приходиться от 8 до 12 курочек. Уже в 6 месяцев самки могут нести первые яйца. В то время как петуха используют только 2-3 года.',
            imgTag: 'gallus',
            ...
            description: 'Птица хороша тем, что не требует отдельного помещения – 50 перепелов легко размещаются в клетке на 1 м2 площади. При этом за день они могут снести около 50 яиц весом 10г.',
            imgTag: 'coturnix',
            ...
            description: 'Во время брачного периода самцы становятся агрессивными, их ноги и шея окрашиваются в яркие цвета, они трубят и шипят.',
    ...
    ], [
        {
            ...
            description: 'Пение горлицы описывают как негромкое воркование или ритмичное урчание, состоящее из звуков «турр-турр-турр». Такую песню горлица исполняет в кронах деревьев.',
            ...
            description: 'Козодев можно часто увидеть неподалеку от пасущихся домашних животных. В таких местах птицы охотятся на мух, слепней и другие виды насекомых, которые сопровождают домашних животных.',
            ...
            description: 'Голос серой цапли звучит как грубый скрежещущий звук, который напоминает низкое короткое карканье. Эту позывку цапля обычно издает на лету. Она громкая и слышна на больших расстояниях.',
            ...
            name: 'Удод',
            species: 'Upupa epops',
            description: 'Голос удода глухой, гортанный, состоит из криков «уп-уп-уп» или «уд-уд-уд», которые повторяются несколько раз подряд. Испуганная птица издаёт пронзительный вопль «чии-иир».',
            imgTag: 'upupa-epops',
    ...
    ], [
        {
            ...
            description: 'Песня жаворонков наполнено многочисленным количеством разнообразных и захватывающих звуков. Каждый звук - отличительный, которая зависит от индивидуальных особенностей.',
            ...
            description: 'Название птицы связывают с ее характерным пением, которое состоит из журчащей трели «сви-ри-ри-ри-ри», похожей на мелодию свирели.',
    ...
    ], [
        {
            ...
            name: 'Зяблик',
            species: 'Fringilla coelebs',
            description: 'Пение зябликов – это заливистые многоминутные рулады. Концерты устраивают самцыа. Трели зябликов торжественные, радостные, раскатистые.',
            ...
            description: 'Для ласточек характерно негромкое щебетание. Песни ласточек не смолкают на протяжении летнего периода. Различают у птиц до 6 щебечущих звуков: «вит», «ви-вит», «чивит», «чиривит».',
